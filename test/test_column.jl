...
@testset "DrainingAbc_SimpleGroundwater" begin
    ...
    σ′ = fill(0, nlayer)
    γ_w = fill(18_000.0, nlayer)
    γ_d = fill(13_000.0, nlayer)
    c_d = fill(2, nlayer)
    ...
    groundwater = Atlans.SimpleGroundwater(z, Δz, boundary, boundary_ϕ, γ_water)
    consolidation = Atlans.draining_abc_isotache_column(Δz, γ_w, γ_d, c_d, c_v, a, b, c)
