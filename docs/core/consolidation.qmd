...
![Change of equilibrium (drained) pore pressure due to a drop of the water table. (a) Aquifer pressure (and head) follows the water table drop. (b) Aquifer pressure (and head) remain stable.](../images/equilibrium_change.png){#fig-equilbrium-change width=500}