...
Atlantis is a modelling environment which is implemented in the [Julia programming language](https://julialang.org/). The source code can found in the [GitHub](https://github.com/Deltares-research/Atlans.jl).
